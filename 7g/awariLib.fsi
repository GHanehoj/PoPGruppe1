...
/// <returns>True if it is the home pit</returns>
...
/// <returns>A new board after the beans of pit i has been distributed, and the pit the last bean landed in</returns>
