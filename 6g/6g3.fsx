// Tager en kædebrøk, samt en variabel, i, som fortæller hvor præcis en approximation
// retur værdien skal være. Returværdien vil være t_i/n_i, returneret som en tuple (t_i,n_i)
let cfrac2frac (lst: int list) (i:int) : (int*int) = 
    // Dette er den rekursive funktion, der laver selve approximationen. Base case er i = 0 og i = -1, i modsætning til opgaven, 
